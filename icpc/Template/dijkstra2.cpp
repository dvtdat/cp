/*
    ...
    This Dijkstra version involves trying the find the best solution based on the CURRENT nodes,
    rather than the adjacent nodes of the current node. 
    Complexity: O(E * logV)
*/
